select
	...
	sum(case when he_yue_lei_xing_ like '%聲音%' then catnip/cr.usd_currency else 0 end)*0.19 as voice_share,
	sum(case when he_yue_lei_xing_ not like '%聲音%' and he_yue_lei_xing_ is not null then catnip/cr.usd_currency else 0 end)*0.19 as video_share
